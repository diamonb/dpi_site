      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="{{route('accueilmarketing')}}">DPI Marketing</a></li>
                <li><a class="dropdown-item" href="{{route('accueilfinance')}}">DPI Finance</a></li>
                <li><a class="dropdown-item" href="{{route('accueildigital')}}">DPI Digital</a></li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="{{route('accueilmarketing')}}">VMVO</a></li>
                <li><a class="dropdown-item" href="{{route('accueildpi')}}">Company</a></li>
                <li><a class="dropdown-item" href="{{route('accueilfinance')}}">Leadership</a></li>
              </ul>
            </li>
            <li class="nav-item">
