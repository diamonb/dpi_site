    ...
    <body>
        <div class="content"> 
            <div class="mail_box">
                ...
                <hr>
                <p>Hi <?=$name?>, </p>
                <p>We appreciate your message and would like to express our gratitude. </p>
                <p>Our team is currently reviewing your request and will be in touch with you shortly to initiate the process.</p>
                <p>Request ID: <i><?=$reference?></i></p> 
