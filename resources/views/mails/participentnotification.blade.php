    ...
    <body>
        <div class="content"> 
            <div class="mail_box">
                ...
                <hr>
                <p>Hi Team, </p>
                <p>We are delighted to announce that a <strong>“Become a participant”</strong> application has been successfully processed. </p>  
                 <p>Kindly reach out to the client promptly to proceed with the next steps.</p>
                <p>Thank you,</p>
                <p>Application ref: <strong><?=$reference?></strong></p>
                <p>Thank you,</p>
                <p>The Digital Team</p>
            </div>
            <div class="content2">
