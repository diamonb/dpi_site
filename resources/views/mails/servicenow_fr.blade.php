    ...
    <body>
        <div class="content"> 
            <div class="mail_box">
                ...
                <hr>
                <p>Bonjour  <?=$name?>,</p>
                <p>Merci d'avoir soumis votre demande. Notre équipe vous contactera pour procéder aux formalités d’enrôlement.</p>
                <p>Demande réf: <strong><?=$reference?></strong></p>
                <p>Merci,</p>
                <p>L’Equipe SNOW Training</p>
            </div>
            <div class="content2">
